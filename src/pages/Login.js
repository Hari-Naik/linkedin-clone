    ...
    <div className="h-screen overflow-y-auto">
      <header className="flex items-center justify-between py-5 px-5 lg:justify-around lg:px-0">
        <img
          ...
          alt="login logo"
          className=" w-24 md:w-[135px] md:h-[34px]"
        />
        <div className="flex items-center md:divide-x divide-gray-500">
          ...
          <div className="flex space-x-6">
            <button className=" text-gray-700 font-semibold cursor-pointer hover:bg-gray-100 py-2 px-3 md:px-4 rounded-full">
              Join now
            </button>
            <button className="text-blue-700 font-semibold text-lg md:text-sm py-2 px-3 md:px-4 rounded-full border-[2px] border-blue-500 cursor-pointer hover:bg-blue-100/40">
              Sign in
            </button>
          </div>
        </div>
        ...
        <div className="md:w-1/2 xl:width-[55%] ">
          ...
          <form className="pt-6" onSubmit={handleSignIn}>
            <div className="flex flex-col mb-3">
              <label htmlFor="Email" className=" text-sm font-semibold py-3">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="flex flex-col">
              <label htmlFor="Password" className=" text-sm font-semibold py-3">
                Password
              </label>
              <div className="relative w-full flex">
                ...
                {type === "password" && (
                  <button
                    className="text-blue-700 font-semibold z-10 -m-14 cursor-pointer"
            ...
            <button
              type="submit"
              className="bg-blue-500 hover:bg-blue-700 transition duration-300 text-white w-full py-3 rounded-full cursor-pointer mt-6 text-md font-semibold">
              Sign in
            </button>
          </form>
          <button
            onClick={handleSignUp}
            className="w-full text-md font-semibold text-gray-500 cursor-pointer border border-black rounded-full py-3 mt-5">
