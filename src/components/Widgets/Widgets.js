  ...
  return (
    <div className="md:sticky -top-[203px] hidden lg:flex flex-col items-center space-y-2 w-max">
      <div className="bg-white w-full border border-gray-300 rounded-lg">
        ...
        <ul>
          <NewsItem
            title="Does WFH affect career progression?"
            time="1d ago"
            readers="10,839 readers"
          />
          <NewsItem
            title="Wait lengthens for US visas"
            time="21h ago"
            readers="2,110 readers"
          />
          <NewsItem
            title="NIT students land big offers"
            time="1d ago"
            readers="13,275 readers"
          />
          <NewsItem
            title="Should moonlighting be a concern"
            time="20h ago"
            readers="1,074 readers"
          />
          <NewsItem
            title="यह-है-कामयाब-लोगों-की-आदतें"
            time="1d ago"
            readers="5,452 readers"
          />
        </ul>
      </div>
